...
public class IntRefDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        // Get properties
        var useSimpleValueProperty = property.FindPropertyRelative(IntRef.UseSimpleValue);
        var variableProperty = property.FindPropertyRelative(IntRef.Variable);
        var simpleValueProperty = property.FindPropertyRelative(IntRef.SimpleValue);
